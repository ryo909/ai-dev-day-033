import './style.css';
const PROFILE = {"day":"Day033","title":"Triage Flow Board 1","display_name_ja":"流れ見直しボード","one_sentence":"作業の流れのつまる場所を見つけるためのツールです。","purpose_line_ja":"作業の流れのつまる場所を見つけるためのツールです。","use_case_line_ja":"進みが悪い理由を見つけたい時に使います。","how_it_works_line_ja":"作業カードを入れて動かすと、流れの詰まりが見えます。","core_action":"triage","family":"workflow_triage","mechanic":"board_flow","input_style":"board_items","output_style":"board","audience_promise":"relief","publish_hook":"カードの組み合わせから次の試作案を素早く作るデッキ型ツール。（話題:GitHub Trending (A） を visual_demo 角度で見せる","engine":"board_flow","interaction_archetype":"board_flow","page_archetype":"kanban_board","output_shape":"kanban_board","state_model":"board_flow_state","core_loop":"board_items -> board_flow -> board","component_pack":"kanban_board+board","scaffold_id":"flow_board","single_shot_text_generator":false};
